        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="/admin/news">
                            ...
                            columnDefs: [
                                {
                                    ...
                                    var caozuo = '<a style="margin:3px;" href="/admin/news/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                    if (row['id'] != 1) {
