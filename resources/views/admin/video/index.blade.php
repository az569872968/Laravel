                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">视频标题</th>
                            <th class="hidden-sm">视频地址</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="/admin/video">
                            ...
                            columnDefs: [
                                {
                                    ...
                                    var caozuo = '<a style="margin:3px;" href="/admin/video/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
//                                    if (row['id'] != 1) {
...
//                                    }
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '/admin/video/' + id);
                            $("#modal-delete").modal();
                        });
