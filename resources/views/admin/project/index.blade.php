                    ...
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        @foreach($list as $item=>$value)
                            <tr>
                                ...
                                <th class="hidden-sm"><a href="/admin/tender/index?project_id={{$value['id']}}&fid=0">工程招标</a>&nbsp;&nbsp;<a href="/admin/contract/index?project_id={{$value['id']}}&fid=0">进度款统计</a>&nbsp;&nbsp;<a href="/admin/settlement/index?project_id={{$value['id']}}&fid=0">工程预算</a>&nbsp;&nbsp;<a href="/admin/project/{{$value['id']}}/summary">工程结算</a>&nbsp;&nbsp;<a href="">工程审计</a> </th>
